    ...
    public function generate() {
        ...
        if (!isset($parent) and !isset($relation)) {
            ...
            foreach ($csv as $key => $value) {
                ...
                //создаем индекс $relation[узел][его relation] - массив, где ключи это названия узлов которые содержат Relation, а значениы это названия Relation (которые уже содержаться как родительские узлы в индексе Parent)
